...
test_name = "cnn_batchnorm_AdvanceL2_200epochs"
netid = "pwf227"
# Hyper-parameters 
num_epochs = 200 #6
batch_size = 128 #128
        ...
        if (i+1) % k == 0:
            ...
            if use_AutoL2:
                ...
                if len(train_bareloss) > 2 and i > min_step:
                    if loss_or_error_increase(train_bareloss[-1], train_acc[-1], min_loss, max_acc) \
                    ...
                    elif loss_or_error_increase(min_loss, max_acc, train_bareloss[-1], train_acc[-1]) \
                        and loss_or_error_increase(min_loss, max_acc, train_bareloss[-2], train_acc[-2]):
